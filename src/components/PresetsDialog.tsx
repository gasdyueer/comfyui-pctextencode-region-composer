...
const PresetsDialog: React.FC<PresetsDialogProps> = ({ open, onClose, onApply, canvas }) => {
      ...
      <div className="relative w-[680px] max-h-[80vh] bg-slate-900 border border-slate-700 rounded-xl shadow-2xl shadow-black/60 flex flex-col overflow-hidden animate-in fade-in">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-slate-200">蒙版预设</h3>
            <span className="text-xs text-slate-600">选择常用区域布局快速开始</span>
          </div>
          <button
            onClick={onClose}
